                    ...
                    <div class="p-4 md:p-6">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-3 flex flex-col sm:flex-row sm:items-center sm:space-x-6 space-y-2 sm:space-y-0">
                                    <!-- ユーザー情報 -->
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div
                                                ...
                                                class="flex items-center text-xs text-gray-700 flex-shrink-0 ml-2">
