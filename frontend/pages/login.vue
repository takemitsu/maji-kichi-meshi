<template>
    <div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style="min-height: calc(100vh - 64px)">
        <div class="max-w-md w-full space-y-8">
            <div>
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">マジキチメシにログイン</h2>
                <p class="mt-2 text-center text-sm text-gray-600">吉祥寺地域の個人的な店舗ランキングを作成・共有</p>
            </div>
            ...
            <div class="mt-8 space-y-4">
                ...
                <div class="text-center">
                    <NuxtLink to="/" class="text-sm text-gray-600 hover:text-gray-900">← ホームに戻る</NuxtLink>
                </div>
            </div>
        </div>
    </div>
