    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="mt-8 space-y-4">
        ...
        <div class="space-y-3">
          ...
          >
            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 0C5.373 0 0 4.975 0 11.111c0 2.47.912 4.727 2.414 6.533-.141-.499-.266-1.144-.266-1.144l-1.474-7.056A.5.5 0 01.84 8.92l2.064-.413a.5.5 0 01.584.325l1.17 3.845c.06.196.295.307.49.246l2.396-.744a.5.5 0 01.584.325l.94 3.096c.06.196.295.307.49.246l2.396-.744a.5.5 0 01.584.325l.94 3.096c.06.196.295.307.49.246l2.396-.744a.5.5 0 01.584.325l1.17 3.845c.088.289.446.417.696.248C22.412 15.838 24 13.627 24 11.111 24 4.975 18.627 0 12 0z"/>
            </svg>
            LINE でログイン
          </button>
...
useHead({
  title: 'ログイン - マジキチメシ',
  meta: [
    { name: 'description', content: 'マジキチメシにログインして、吉祥寺地域の店舗ランキングを作成・共有しましょう' }
  ]
})
</script>